...
export const PageTemplate = (props: IPageTemplateProps) => {
  ...
  return (
    ...
    >
      <nav
        className={`bg-blue-bg left-[-100%] top-0 pt-9 z-10 px-6 fixed transition-all h-full w-full  md:max-w-[235px] md:relative md:z-0 md:left-0 ${
      ...
      <div
        className="fixed z-20 bg-yellow max-w-[320px] w-full flex justify-center items-center rounded-[40px] h-[60px] right-[50%] translate-x-[50%] bottom-4 md:hidden"
